...
# python3.10 be_zivilstraf_scraper.py -p BE_ZivilStraf -s BE_ZivilStraf_clean
...
# die verschiedenen Gerichte, von denen die Entscheide in diesem Ordner zu finden sind
GERICHTE = ["ABS", "BK", "ZK", "HG", "SK", "KES", "WSG"]
