...
parser.add_argument("-d","--directory",type=str,default="TG_OG",help="current directory for the scraper")
...
SAVE_PATH = "/home/admin1/tb_tool/clean_scraper_data/TG_OG_clean/"
...
def parse_text(parsed_html) -> List[str]:
	...
	text = []
	tag_list = parsed_html.findAll(["title", "p"])
