...
# python3.10 ch_bpatg_scraper.py -p CH_BPatG -s CH_BPatG_clean
...
def get_paras(lines: List[str]) -> List[str]:
    ...
    for i, line in enumerate(lines):
        ...
        if ("Erwägungen" in line or "Sachverhalt" in line or "Rekurs" in line or "Regeste" in line or "Erwägung" in line) and sachverhalt_counter == 0:
