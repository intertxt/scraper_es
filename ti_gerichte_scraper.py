...
parser.add_argument("-d","--directory",type=str,default="TI_Gerichte",help="current directory for the scraper")
...
SAVE_PATH = "/home/admin1/tb_tool/clean_scraper_data/TI_Gerichte_clean/"
...
def iterate_files(directory, filetype):
	fname_list = []
	for filename in sorted(os.listdir(directory))[87910:]:
