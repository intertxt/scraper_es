...
parser.add_argument("-d","--directory",type=str,default="VD_Omni",help="current directory for the scraper")
...
SAVE_PATH = "/home/admin1/tb_tool/clean_scraper_data/VD_Omni_clean/"
