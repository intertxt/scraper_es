...
parser.add_argument("-d","--directory",type=str,default="SO_Omni",help="current directory for the scraper")
...
SAVE_PATH = "/home/admin1/tb_tool/clean_scraper_data/SO_Omni_clean/"
