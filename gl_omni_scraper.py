...
parser.add_argument("-d","--directory",type=str,default="GL_Omni",help="current directory for the scraper")
...
SAVE_PATH = "/home/admin1/tb_tool/clean_scraper_data/GL_Omni_clean/"
